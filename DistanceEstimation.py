...
while True:
    ...
    for d in data:
        ...
        x_new = (((x)/frame.shape[1])*255)-128+80-45
        y_new = (((y)/frame.shape[0])*255)-128
        print(
            f"Object: {d[0]}, X: {x_new}, Y: {y_new}, Z: {distance}")
        # {-10 to 10} go straight
        # until straight flag is 1, continue current operation
        # more than 10. turn right
        # less than -10. turn left
        if (x_new > 20):
            turnRight(1)
            turnLeft(0)
            goStraight(0)
